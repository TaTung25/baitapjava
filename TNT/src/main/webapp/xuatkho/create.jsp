        ...
        <div class="col-md-9">
            ...
            <div class="card shadow">
                <div class="card-header bg-danger text-white fw-bold">
                    <i class="bi bi-box-arrow-up-right me-2"></i>TẠO PHIẾU XUẤT KHO
                </div>
                <div class="card-body">
                    <form action="${pageContext.request.contextPath}/PhieuXuatServlet" method="post">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-bold">Ghi Chú Xuất Hàng</label>
                                <input type="text" name="ghiChu" class="form-control" placeholder="Xuất bán / Chuyển kho...">
                            </div>
                        </div>

                        <h5 class="fw-bold mt-4 mb-3 text-secondary">Sản Phẩm Xuất Kho</h5>
                        <table class="table table-bordered">
                            <thead class="table-light">
                                <tr>
                                    <th style="width: 35%;">Sản Phẩm (Tồn kho)</th>
                                    <th style="width: 15%;">Số Lượng Xuất</th>
                                    <th style="width: 25%;">Đơn Giá Bán</th>
                        ...
                        <div class="row justify-content-end text-end mt-3">
                            <div class="col-md-5">
                                <h4 class="fw-bold text-danger">Tổng Thành Tiền: <span id="lblTongTien">0</span> VNĐ</h4>
                            </div>
                        </div>

                        <hr>
                        <div class="d-flex justify-content-end gap-2">
                            <a href="${pageContext.request.contextPath}/PhieuXuatServlet" class="btn btn-secondary">Hủy</a>
...
<script>
    ...
    function calculateRow(element) {
        ...
        if (sl > stock && selectedOpt.value !== "") {
            alert("Cảnh báo: Số lượng xuất (" + sl + ") vượt quá số lượng tồn kho (" + stock + ")!");
